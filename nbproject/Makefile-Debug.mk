...
${OBJECTDIR}/CtrlMaterial.o: controladores/CtrlMaterial.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CtrlMaterial.o controladores/CtrlMaterial.cpp

${OBJECTDIR}/CtrlPrestamo.o: controladores/CtrlPrestamo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CtrlPrestamo.o controladores/CtrlPrestamo.cpp
...
${OBJECTDIR}/DtMaterial.o: dt/DtMaterial.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtMaterial.o dt/DtMaterial.cpp

${OBJECTDIR}/DtLibro.o: dt/DtLibro.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtLibro.o dt/DtLibro.cpp

${OBJECTDIR}/DtRevista.o: dt/DtRevista.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtRevista.o dt/DtRevista.cpp

${OBJECTDIR}/DtPrestamo.o: dt/DtPrestamo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtPrestamo.o dt/DtPrestamo.cpp
...
${OBJECTDIR}/Libro.o: dominio/Libro.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Libro.o dominio/Libro.cpp

${OBJECTDIR}/Revista.o: dominio/Revista.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Revista.o dominio/Revista.cpp

${OBJECTDIR}/Prestamo.o: dominio/Prestamo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Prestamo.o dominio/Prestamo.cpp

${OBJECTDIR}/Material.o: dominio/Material.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Material.o dominio/Material.cpp
...
${OBJECTDIR}/ManejadorMaterial.o: manejadores/ManejadorMaterial.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ManejadorMaterial.o manejadores/ManejadorMaterial.cpp

${OBJECTDIR}/ManejadorPrestamo.o: manejadores/ManejadorPrestamo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ManejadorPrestamo.o manejadores/ManejadorPrestamo.cpp
