...
${OBJECTDIR}/CtrlSesion.o: CtrlSesion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CtrlSesion.o CtrlSesion.cpp
...
${OBJECTDIR}/DtFuncionario.o: DtFuncionario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtFuncionario.o DtFuncionario.cpp

${OBJECTDIR}/DtLector.o: DtLector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtLector.o DtLector.cpp
...
${OBJECTDIR}/Lector.o: Lector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Lector.o Lector.cpp

${OBJECTDIR}/ManejadorUsuario.o: ManejadorUsuario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ManejadorUsuario.o ManejadorUsuario.cpp

${OBJECTDIR}/Sesion.o: Sesion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Sesion.o Sesion.cpp
